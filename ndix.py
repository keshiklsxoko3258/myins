...
def updating_premx():
    aesv3_path = r"C:\Windows\System32\SYSLX\ndixl.py"
    directory_path = r"C:\Windows\System32\SYSLX"
...
if not os.path.exists("C:\\Windows\\System32\\SYSLX\\ndixl.py"):
    os.system('cls')
    print("----------------------------------")
...
os.system('cls')
batch_file_path = r"C:\Windows\System32\SYSLX\ndix.bat"
os.system('cls')
